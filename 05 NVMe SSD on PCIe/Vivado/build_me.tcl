...
#
# build_me.tcl: Tcl script for re-creating project 'umyir1'
#
# Generated by Vivado on Sat Apr 25 22:56:25 BST 2020
...
#
# 1. This project restoration tcl script (build_me.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/joan/vivado_workspace/umyir1/umyir1.srcs/sources_1/bd/ps/hdl/ps_wrapper.v"
#
...
set orig_proj_dir "[file normalize "$origin_dir/sources"]"
...
set files [list \
 [file normalize "${origin_dir}/sources/ps_wrapper.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ps_wrapper" -objects $obj
...
# Proc to create BD ps
proc cr_bd_ps { parentCell } {
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
...
# End of cr_bd_ps()
cr_bd_ps ""
set_property REGISTERED_WITH_MANAGER "1" [get_files ps.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ps.bd ] 

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu3eg-sfvc784-1-e -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu3eg-sfvc784-1-e -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
