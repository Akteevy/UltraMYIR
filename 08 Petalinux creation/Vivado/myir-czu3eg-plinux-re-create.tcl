...
#
# myir-czu3eg-plinux-re-create.tcl: Tcl script for re-creating project 'myir'
#
# Generated by Vivado on Sun Oct 02 11:47:33 BST 2022
...
#
# 1. This project restoration tcl script (myir-czu3eg-plinux-re-create.tcl) that was generated.
#
...
set script_file "myir-czu3eg-plinux-re-create.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/myir_board/myir"]"
...
set_property -name "platform.board_id" -value "ultramyir" -objects $obj
...
proc cr_bd_bd { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {150.000000} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-136,-113",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 90 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 2 20 180 640
levelinfo -pg 1 0 330 660
pagesize -pg 1 -db -bbox -sgen 0 0 660 190
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/myir_board/myir/myir.gen/sources_1/bd/bd/hdl/bd_wrapper.v" ]
} else {
