proc getPresetInfo {} {
  return [dict create name {myc-czu3eg-plinux-config} description {myc-czu3eg-plinux-config}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 display_name {myc-czu3eg-plinux-config} ]
}
