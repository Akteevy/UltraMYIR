...
#
# build_FftFp.tcl: Tcl script for re-creating project 'FftFp'
#
# Generated by Vivado on Sun Feb 09 17:08:06 +0000 2020
...
#
# 1. This project restoration tcl script (build_FftFp.tcl) that was generated.
#
...
set _xil_proj_name_ "Ultramyir_03"
...
set script_file "build_um03.tcl"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/xilinx.com_ip_edge_detect_1.0"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/edge_detect.v"]\
 [file normalize "${origin_dir}/dma_wrapper.v"]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "dma_wrapper" -objects $obj
...
if { [get_files edge_detect.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Akteevy/XilinxVivado/FftFp/FftFp.srcs/sources_1/imports/lib/edge_detect.v
}


# Proc to create BD dma
proc cr_bd_dma { parentCell } {
...
proc create_hier_cell_ps { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__DP_STC_REF_CTRL__ACT_FREQMHZ {26.666662} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins S01_AXI] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins pl_ps_irq0] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins pl_clk0] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins ps/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins ps/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins ps/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins ps/M01_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins edge_detect_0/din] [get_bd_pins xfft_0/s_axis_config_tdata]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps/ARESETN]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins ps/pl_ps_irq0] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins edge_detect_0/clk] [get_bd_pins ps/pl_clk0] [get_bd_pins xfft_0/aclk]

  # Create address segments
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HPC0_DDR_HIGH
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HPC0_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] SEG_zynq_ultra_ps_e_0_HPC0_QSPI
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] SEG_zynq_ultra_ps_e_0_HPC0_QSPI
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
...
#  -string -flagsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 2 -y 330 -defaultsOSRD -orient R180
preplace inst ps -pg 1 -lvl 2 -y 550 -defaultsOSRD -resize 237 158
preplace inst edge_detect_0 -pg 1 -lvl 1 -y 140 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 1 -y 360 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -y 530 -defaultsOSRD
preplace inst xfft_0 -pg 1 -lvl 2 -y 110 -defaultsOSRD
preplace netloc axi_interconnect_1_M01_AXI 1 0 3 30 640 N 640 820
preplace netloc edge_detect_0_edge_detected 1 1 1 360
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 10 220 360 450 830
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 0 3 40 650 N 650 850
preplace netloc xfft_0_M_AXIS_DATA 1 2 1 840
preplace netloc axi_dma_0_s2mm_introut 1 0 2 20 270 NJ
preplace netloc axi_dma_0_M_AXI_MM2S 1 1 1 380
preplace netloc axi_gpio_0_gpio_io_o 1 0 2 50 210 340
preplace netloc xlconcat_0_dout 1 1 1 350
preplace netloc axi_dma_0_mm2s_introut 1 0 2 50 280 350J
preplace netloc axi_dma_0_M_AXI_S2MM 1 1 1 370
preplace netloc axi_interconnect_1_M00_AXI 1 2 1 820
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 1 370
levelinfo -pg 1 -10 200 608 870 -top -10 -bot 1050
"
}
...
# End of cr_bd_dma()
cr_bd_dma ""
set_property REGISTERED_WITH_MANAGER "1" [get_files dma.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files dma.bd ] 
