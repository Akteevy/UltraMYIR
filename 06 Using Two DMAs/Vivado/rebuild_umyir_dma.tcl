...
#
# rebuild_umyir_dma.tcl: Tcl script for re-creating project 'umyir_dma'
#
# Generated by Vivado on Sun Jul 05 17:28:17 +0100 2020
...
#
# 1. This project restoration tcl script (rebuild_umyir_dma.tcl) that was generated.
#
...
set script_file "rebuild_umyir_dma.tcl"
...
# set orig_proj_dir "[file normalize "$origin_dir/XilinxVivado/umyir_dma"]"
...
set_property -name "board_part" -value "myir.com:ultramyir:part0:1.0" -objects $obj
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "dsa.accelerator_binary_content" -value "bitstream" -objects $obj
set_property -name "dsa.accelerator_binary_format" -value "xclbin2" -objects $obj
set_property -name "dsa.board_id" -value "ultramyir" -objects $obj
...
proc cr_bd_bd { parentCell } {
  ...
  # Create instance: axi_dma_read, and set properties
  set axi_dma_read [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_read ]
  ...
  # Create instance: axi_dma_write, and set properties
  set axi_dma_write [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_write ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash##Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0###########UART 0#UART 0#########SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out##n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow###########rxd#txd#########sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__ACT_FREQMHZ {24.999994} \
   CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__DIVISOR0 {63} \
   CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__FREQMHZ {25} \
   CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__SRCSEL {RPLL} \
   CONFIG.PSU__CRF_APB__DP_AUDIO__FRAC_ENABLED {0} \
   CONFIG.PSU__CRF_APB__DP_STC_REF_CTRL__ACT_FREQMHZ {26.666660} \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {149.999969} \
  ...
  connect_bd_intf_net -intf_net axi_dma_read_M_AXIS_MM2S [get_bd_intf_pins axi_dma_read/M_AXIS_MM2S] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_read_M_AXI_MM2S [get_bd_intf_pins axi_dma_read/M_AXI_MM2S] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_write_M_AXI_S2MM [get_bd_intf_pins axi_dma_write/M_AXI_S2MM] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axi_dma_write/S_AXIS_S2MM] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins axi_dma_read/S_AXI_LITE] [get_bd_intf_pins smartconnect_1/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins axi_dma_write/S_AXI_LITE] [get_bd_intf_pins smartconnect_1/M01_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins smartconnect_1/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]

  # Create port connections
  connect_bd_net -net axi_dma_read_mm2s_introut [get_bd_pins axi_dma_read/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_write_s2mm_introut [get_bd_pins axi_dma_write/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_read/axi_resetn] [get_bd_pins axi_dma_write/axi_resetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_read/m_axi_mm2s_aclk] [get_bd_pins axi_dma_read/s_axi_lite_aclk] [get_bd_pins axi_dma_write/m_axi_s2mm_aclk] [get_bd_pins axi_dma_write/s_axi_lite_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxi_lpd_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_read/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_DDR_LOW] SEG_zynq_ultra_ps_e_0_LPD_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_read/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_LPS_OCM] SEG_zynq_ultra_ps_e_0_LPD_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_read/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_QSPI] SEG_zynq_ultra_ps_e_0_LPD_QSPI
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_write/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_DDR_LOW] SEG_zynq_ultra_ps_e_0_LPD_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_write/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_LPS_OCM] SEG_zynq_ultra_ps_e_0_LPD_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_write/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_QSPI] SEG_zynq_ultra_ps_e_0_LPD_QSPI
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_read/S_AXI_LITE/Reg] SEG_axi_dma_read_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x80001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_write/S_AXI_LITE/Reg] SEG_axi_dma_write_Reg
...
#  -string -flagsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 1 -y 330 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -y 357 -defaultsOSRD -resize 478 132
preplace inst smartconnect_1 -pg 1 -lvl 3 -y 360 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -y 470 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -y 547 -defaultsOSRD
preplace inst axi_dma_write -pg 1 -lvl 3 -y 197 -defaultsOSRD
preplace inst axi_dma_read -pg 1 -lvl 1 -y 170 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 2 -y 177 -defaultsOSRD
preplace netloc axi_dma_write_M_AXI_S2MM 1 0 4 70 70 N 70 N 70 1370
preplace netloc axi_dma_read_mm2s_introut 1 0 2 40 30 440
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 50 50 450 267 1000
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 2 1 1020
preplace netloc axi_dma_write_s2mm_introut 1 0 4 20 10 NJ 10 NJ 10 1400
preplace netloc axi_dma_read_M_AXI_MM2S 1 0 2 80J 80 430J
preplace netloc smartconnect_0_M00_AXI 1 1 1 NJ
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 0 3 30 20 N 20 1010
preplace netloc xlconcat_0_dout 1 1 1 460
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 3 60 40 470J 257 1030
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 2 470 447 990
preplace netloc smartconnect_1_M01_AXI 1 2 2 1030J 97 1380
preplace netloc axis_data_fifo_0_M_AXIS 1 2 1 N
preplace netloc axi_dma_read_M_AXIS_MM2S 1 1 1 460J
preplace netloc smartconnect_1_M00_AXI 1 0 4 90 60 N 60 N 60 1390
levelinfo -pg 1 0 260 730 1200 1420 -top 0 -bot 650
"
}
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu3eg-sfvc784-1-e -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu3eg-sfvc784-1-e -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
